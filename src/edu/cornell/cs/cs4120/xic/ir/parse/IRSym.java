...
public class IRSym {
    ...
    public static final String[] terminalNames = new String[] { "EOF", "error", "LPAREN", "RPAREN", "MOVE", "EXP",
            "SEQ", "JUMP", "CJUMP", "LABEL", "RETURN", "CONST", "TEMP", "MEM", "CALL", "NAME", "ESEQ", "ADD", "SUB",
            "MUL", "HMUL", "DIV", "MOD", "AND", "OR", "XOR", "LSHIFT", "RSHIFT", "ARSHIFT", "EQ", "NEQ", "LT", "GT",
            "LEQ", "GEQ", "FUNC", "COMPUNIT", "ATOM", "NUMBER" };
}
