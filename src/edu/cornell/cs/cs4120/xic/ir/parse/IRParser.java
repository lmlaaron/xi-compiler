...
public class IRParser extends java_cup.runtime.lr_parser {
    ...
    protected static final short _production_table[][] = unpackFromStrings(
            new String[] { "\000\062\000\002\002\004\000\002\002\007\000\002\003"
                    ...
                    + "\000\002\005\004\000\002\010\002\000\002\010\003\000" + "\002\011\003\000\002\011\004" });
    ...
    protected static final short[][] _action_table = unpackFromStrings(
            new String[] { "\000\171\000\004\004\004\001\002\000\004\046\007\001"
                    ...
                    + "\005\ufff6\001\002\000\004\005\ufff3\001\002\000\006\004" + "\ufffb\005\ufffb\001\002" });
    ...
    protected static final short[][] _reduce_table = unpackFromStrings(
            new String[] { "\000\171\000\004\002\004\001\001\000\002\001\001\000"
                    ...
                    + "\167\001\001\000\004\012\170\001\001\000\002\001\001" + "\000\002\001\001\000\002\001\001" });
    ...
    public java_cup.runtime.Symbol do_action(int act_num, java_cup.runtime.lr_parser parser,
            java.util.Stack<java_cup.runtime.Symbol> stack, int top) throws java.lang.Exception {
    ...
    class CUP$IRParser$actions {
        ...
        public final java_cup.runtime.Symbol CUP$IRParser$do_action_part00000000(int CUP$IRParser$act_num,
                java_cup.runtime.lr_parser CUP$IRParser$parser,
                java.util.Stack<java_cup.runtime.Symbol> CUP$IRParser$stack, int CUP$IRParser$top)
            ...
            /* . . . . . . */
            default:
                throw new Exception("Invalid action number " + CUP$IRParser$act_num + " found in internal parse table");

            }
        } /* end of method */

        /** Method splitting the generated action code into several parts. */
        public final java_cup.runtime.Symbol CUP$IRParser$do_action(int CUP$IRParser$act_num,
                java_cup.runtime.lr_parser CUP$IRParser$parser,
                java.util.Stack<java_cup.runtime.Symbol> CUP$IRParser$stack, int CUP$IRParser$top)
                throws java.lang.Exception {
            return CUP$IRParser$do_action_part00000000(CUP$IRParser$act_num, CUP$IRParser$parser, CUP$IRParser$stack,
                    CUP$IRParser$top);
        }
    }
