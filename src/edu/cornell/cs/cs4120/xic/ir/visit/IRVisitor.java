...
public abstract class IRVisitor implements Copy<IRVisitor> {
     ...
     * node {@code n0} is returned, the traversal is stopped and the resulting AST
     * has {@code n0} in place of {@code n}.
     *
     ...
     * perform certain actions, including returning a new Node visitor to be used in
     * the subtree.
     */
    ...
    protected <V extends IRVisitor> V copyIfNeeded(V v) {
        if (v == this)
            return edu.cornell.cs.cs4120.util.Copy.Util.copy(v);
        return v;
    }
