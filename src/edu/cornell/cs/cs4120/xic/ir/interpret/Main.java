...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        IRStmt bBody = new IRSeq(new IRMove(new IRTemp("i"), new IRTemp(arg0)),
                new IRMove(new IRTemp("j"), new IRTemp(arg1)),
                new IRMove(new IRTemp("x"), new IRCall(new IRName("a"), new IRTemp("i"), new IRTemp("j"))),
                new IRMove(new IRTemp("y"), new IRTemp(ret1)),

                new IRReturn(new IRBinOp(OpType.ADD, new IRTemp("x"),
