...
public class CallTile extends Tile {
    ...
    protected Assembly generateLocalAssembly() {
        ...
        // check return size, if greater than 2, allocate space on stack first, rcx is
        // reserved for this
        // System.out.print(this.retSize());
        // if (this.retSize() > 2) {
        // statements.add(new AssemblyStatement("mov", new AssemblyOperand("rcx"), new
        // AssemblyOperand("RETPOINTER")));
        // }
        ...
        for (int i = this.getSubtreeRoots().size() - 1; i > 6; i--) {
            ...
            statements.add(new AssemblyStatement("mov",
                    new AssemblyOperand("[rsp-" + String.valueOf((this.getSubtreeRoots().size() - 1 - i) * 8) + "]"),
                    new AssemblyOperand()));
        }
        ...
        // statements.add(new AssemblyStatement("mov", new AssemblyOperand(), new
        // AssemblyOperand("rax")));
